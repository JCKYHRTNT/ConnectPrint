...
<div class="tb-card p-4">
    ...
    @forelse($items as $item)
        <div class="border rounded p-3 mb-2">
            ...
            @if($item->artwork)
                <a class="btn btn-outline-primary btn-sm mt-2" href="{{ route('artworks.print-file', ['username' => $item->purchase->user->slug, 'artwork' => $item->product_id]) }}">Open print-ready file</a>
            @endif
