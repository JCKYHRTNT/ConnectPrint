...
<div class="tb-card p-4">
    <div class="row g-3">
        ...
        <div class="col-md-7">
            ...
            <p style="font-size:0.9rem;font-weight:500;color:#111827;margin-bottom:0.25rem;">{{ $artwork->is_printable ? 'Printable access' : 'Display only' }} - {{ ucfirst($artwork->moderation_status) }}</p>
